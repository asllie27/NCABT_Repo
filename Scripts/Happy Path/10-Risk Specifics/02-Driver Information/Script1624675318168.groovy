...
WebUI.setText(findTestObject('10-Risk Specifics/02-Driver Information/01-Driver Information/08-txt_AnnualCost_1'), '10')

WebUI.click(findTestObject('10-Risk Specifics/02-Driver Information/01-Driver Information/09-toggle_HireDriver'))

WebUI.setText(findTestObject('10-Risk Specifics/02-Driver Information/01-Driver Information/10-txt_AnnualCost_2'), '20')

WebUI.click(findTestObject('10-Risk Specifics/02-Driver Information/01-Driver Information/11-toggle_LeasingToOthers'))

WebUI.setText(findTestObject('10-Risk Specifics/02-Driver Information/01-Driver Information/12-txt_AnnualIncome_1'), '30')
...
WebUI.setText(findTestObject('10-Risk Specifics/02-Driver Information/01-Driver Information/14-txt_AnnualIncome_2'), '40')
